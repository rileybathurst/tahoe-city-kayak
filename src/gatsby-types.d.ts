...
type ToursQueryQuery = { readonly kayak: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly name: string | null, readonly slug: string | null, readonly price: number | null, readonly peek: string | null, readonly excerpt: string | null, readonly start: string | null, readonly finish: string | null, readonly duration: number | null, readonly timeframe: string | null, readonly fitness: string | null, readonly sport: string | null, readonly ogimage: { readonly alternativeText: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null }> }, readonly paddleBoard: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly name: string | null, readonly slug: string | null, readonly price: number | null, readonly peek: string | null, readonly excerpt: string | null, readonly start: string | null, readonly finish: string | null, readonly duration: number | null, readonly timeframe: string | null, readonly fitness: string | null, readonly sport: string | null, readonly ogimage: { readonly alternativeText: string | null, readonly localFile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null }> }, readonly allStrapiLocation: { readonly nodes: ReadonlyArray<{ readonly name: string | null, readonly link: string | null, readonly svg: string | null, readonly opening_time: string | null, readonly closing_time: string | null, readonly address: { readonly data: { readonly address: string | null } | null } | null, readonly description: { readonly data: { readonly description: string | null } | null } | null, readonly locale: { readonly season_start: string | null, readonly season_end: string | null } | null }> }, readonly strapiLocale: { readonly peek_tours: string | null } | null };
