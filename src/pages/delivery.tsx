  ...
  return (
    <>
      ...
      <main>
        ...
        <p>
          Since every delivery is different, a phone call or email is the best way to make a plan that meets your needs. Our delivery fees depend on how far we are traveling, how many employees we need to send, and how straightforward the delivery is &#40;ie. if we have to carry watercraft down flights of stairs, over rocks, etc&#41;. We aren't trying to make a profit from delivery fees, but we do need to cover our costs.
        </p>
