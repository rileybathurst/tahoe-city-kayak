...
export const Location_Card = ({ primary, backed, label }) => {
  const mode = primary ? 'storybook-Location--primary' : 'storybook-Location--secondary';
  const back = backed ? 'here__card' : 'not';

  return (
    <div className={`location_card ${back}`}>
      <svg
